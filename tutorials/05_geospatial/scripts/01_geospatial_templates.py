...
#
# We can also use a `GeospatialScenario` object. See the [Geospatial Scenario Tutorial](./05_scenario_geospatial.ipynb) for more information on how to use this approach.
#
