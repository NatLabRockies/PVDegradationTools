...
# # Next Steps
#
# Now we have data ready to use for geospatial calculations. This is shown in the other distributed script [05_pvgis_distributed.ipynb](./05_pvgis_distributed.ipynb). You can also see how to do this in [Geospatial Templates.ipynb](../05_geospatial/01_geospatial_templates.ipynb)
